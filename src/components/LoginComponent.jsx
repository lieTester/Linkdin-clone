...
function LoginComponent() {
  return (
    <body className="w-full h-screen p-7 pb-0 font-[system-ui]">
      <header className="w-full  ">
        <img src={logo} alt="LinkedIn-logo" className=" w-auto h-8 md:h-10" />
      </header>
      {/* ---------------------------main -------------------------------------- */}
      <main className=" mt-6 ml-2 h-[70%] ">
        {/* {------------------------------- form    ---------------------------------} */}
        <form
          action=""
          method="post"
          className="block w-[320px] md:w-[350px] !mx-auto p-6 py-7 rounded-lg shadow-[0_4px_12px_0px_rgba(0,0,0,0.15)]"
        >
          <div className="mb-6">
          ...
          <div>
            <button className="text-[16px] w-full mt-6 py-3 text-white rounded-full bg-[#0A66C2]  hover:bg-[#004182]">
              Sign in
            </button>
          </div>
          ...
          <div className="relative text-gray-500 text-[16px] font-semibold">
            <button className="w-full py-1  rounded-full outline outline-1 outline-gray-400 hover:bg-slate-100 hover:ring-2 hover:ring-[#616161] hover:-outline-offset-[.5px]  hover:outline-[#616161] transition-all duration-300">
              <FcGoogle className="inline text-[18px] mb-1 mr-1" /> Sign in with
              Google
            </button>
      ...
      <footer className=" !h-[calc(100%-70%-9%)] pt-8 ">
        ...
        <ul className="flex justify-center mt-11 text-[12px] text-gray-600 [&>li]:px-3 [&>li]:hover:cursor-pointer [&>li:hover]:underline">
