...
function RegisterComponent() {
  return (
    <body className="w-full h-screen  pb-0 font-[system-ui]  md:!bg-[#F3F2F0]">
      <header className="w-[90%] md:w-[70%] mx-auto pt-5">
        <img src={logo} alt="LinkedIn-logo" className=" w-auto h-7 md:h-10" />
      </header>
      {/* ---------------------------main -------------------------------------- */}
      <main className=" w-[100%] h-[70%] md:w-[70%] mx-auto">
        ...
        <form
          action=""
          method="post"
          className="block w-[100%] sm:w-[400px]  !mx-auto p-6 py-7 bg-white rounded-lg md:shadow-[0_4px_12px_0px_rgba(0,0,0,0.15)]"
        >
          ...
          <div>
            <button className="text-[16px] w-full my-4 py-3 text-white rounded-full bg-[#0A66C2]  hover:bg-[#004182]">
              Agree & Join
            </button>
          </div>
      ...
      <footer className="w-full bottom-0 absolute bg-white leading-10 pb-5">
        ...
        <ul className=" flex md:hidden justify-center text-center text-[12px] text-gray-600 [&>*]:px-3 [&>*]:border-l-2 leading-5">
          <li className="border-none">Português</li> <li>Français</li>{" "}
          <li>简体中文</li> <li>More</li>
        </ul>
        {/* big screen footer */}
